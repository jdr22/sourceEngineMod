...
#define	PISTOL_FASTEST_REFIRE_TIME		0.0f // modded by jdr22 //gg65 pistol shoots too fast // @gg65 its supposed to be extreme and not just fast, plus I think its balanced by magazine size
...
public:
	...
	{
		return 0.0f; //mod by jdr22 //gg65 shoots too fast // @gg65 its supposed to be extreme and not just fast, plus I think its balanced by magazine size and relative damage
	}
